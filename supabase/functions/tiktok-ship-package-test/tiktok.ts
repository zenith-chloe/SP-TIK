// Copied verbatim from tiktok-sync-orders/tiktok.ts. Kept as a separate copy
// (not a shared import) so this test function can never accidentally change
// behavior for the real sync function by being edited here.
