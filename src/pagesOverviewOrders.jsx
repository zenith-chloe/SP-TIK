...
import { platformFeeRate, incomeBreakdown, estimatedBreakdown, tiktokEstimatedBreakdown, FeeBreakdownPanel } from "./pagesImportFinance.jsx";
...
// tiktokEstimatedBreakdown() moved to pagesImportFinance.jsx 2026-08-21 —
// now shared by both this Order Drawer and the Finance page, so they can
// never silently diverge on the pre-settlement TikTok estimate formula
// again (see that file's comment on tiktokEstimatedBreakdown for the full
...
function ShopeeStyleOrderDrawerContent({ t, order, onClose, onPrint, onUpdateStatus, onRequestCancel, stepIdx, theme, isAwaitingShip }) {
  ...
  // Seller Shipping Fee + reconciliation catch-all (2026-08-21) — used to be
  // patched on locally here; moved into incomeBreakdown() itself
  // (pagesImportFinance.jsx, user-authorized) 2026-08-21 so the Finance page
  // shows the identical itemized breakdown instead of a shorter one — see
  // that function's comments for the real-data verification. Nothing left
